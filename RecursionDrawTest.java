...
class RecursionDrawTest {
	...
	void testSquares_1() {
		...
		String actual = RecursionDraw.squares(0.5, 0.5, 0.2, 2, blankCanvas);
		String message = "\""; 
		...
		void testDrillPoints_1() {
			...
			actual = RecursionDraw.drillPoints(p1, p2, p3, 1, blankCanvas, actual);
		...
		void testDrillPoints_3() {
			...
			String message = "";
			ArrayList<String> actual = new ArrayList<String>(); 
			actual = RecursionDraw.drillPoints(p1, p2, p3, 0, blankCanvas, actual);
